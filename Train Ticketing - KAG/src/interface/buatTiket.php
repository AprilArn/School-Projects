...
if (isset($_POST['submit'])) {
    ...
    $sql =
        "INSERT INTO penumpang (no_telp, nama_penumpang) VALUES
        ('$no_telp', '$nama_penumpang')";
    $result = mysqli_query($conn, $sql);

    if ($result) {
        $_SESSION['no_telp'] = $no_telp; // Menyimpan nomor telepon ke dalam sesi
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="style/buatTiketStyles.css">
</head>
